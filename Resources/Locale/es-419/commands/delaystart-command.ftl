...
cmd-delaystart-help = Uso: delaystart [segundos | -1 para pausar | 0 para reanudar]
                      Sin argumentos, pausa o reanuda la cuenta regresiva.
...
cmd-delaystart-too-late = No se pudo demorar a tiempo el inicio de la ronda.
