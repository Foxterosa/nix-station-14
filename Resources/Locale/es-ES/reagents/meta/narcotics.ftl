...
reagent-desc-experimental-stimulants = Una version prototipo de hyperzine. Su uso otorga inmunidad virtual a armas de aturdimiento, regeneracion rapida de tejidos, velocidad extrema al correr al reducir la acumulacion de acido lactico y una sensacion general de euforia. Los efectos secundarios pueden incluir niveles extremos de anticoagulacion, vision de tunel, acumulacion extrema de toxinas en la sangre y muerte rapida del higado. No administrar a animales.

reagent-name-thc = THC
reagent-desc-thc = El principal compuesto psicoactivo del cannabis.

reagent-name-bananadine = bananadina
reagent-desc-bananadine = Un psicodelico suave que se encuentra en pequeñas trazas en las cascaras de banana.
...
reagent-desc-mute-toxin = Un quimico espeso que recubre las cuerdas vocales, haciendo que el usuario no pueda hablar durante la metabolizacion.

reagent-name-norepinephric-acid = acido norepinefrico
reagent-desc-norepinephric-acid = Un quimico suave que bloquea los receptores opticos, dejando ciego al usuario durante la metabolizacion.

reagent-name-tear-gas = gas lacrimogeno
reagent-desc-tear-gas = Un quimico que causa irritacion severa y llanto, comunmente usado en control de disturbios.

reagent-name-happiness = felicidad
reagent-desc-happiness = Te llena de un entumecimiento extatico y causa daño cerebral menor. Altamente adictivo. En sobredosis provoca cambios de humor repentinos.
