...
gas-analyzer-object-out-of-range = El objeto quedó fuera de alcance.
gas-analyzer-shutoff = El analizador de gases se apaga.

## UI

gas-analyzer-window-name = Analizador de gases
...
gas-analyzer-window-molarity-column-name = Moles
...
# Nombres más claros para los dispositivos ternarios
