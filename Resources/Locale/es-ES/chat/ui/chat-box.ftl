...
hud-chatbox-channel-Admin = Admin varios
...
# Starlight start
hud-chatbox-highlights = Resaltados del chat
# Starlight end
hud-chatbox-highlights-button = Enviar
hud-chatbox-highlights-tooltip = Las palabras deben ir separadas por un salto de línea;
                                 si se encierran entre " solo se resaltan
                                 cuando están separadas por espacios o puntuación.
