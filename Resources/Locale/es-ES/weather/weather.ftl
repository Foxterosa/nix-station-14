cmd-weatherremove-desc = Elimina un clima específico del mapa.
...
cmd-weather-error-wrong-time = ¡El tiempo tiene un formato incorrecto!
cmd-weather-error-wrong-map = ¡No existe un mapa con MapId {$id}!
cmd-weather-error-no-weather = ¡Este clima no existe en el mapa seleccionado!

cmd-weather-hint-map-id = Id del mapa
cmd-weather-hint-prototype = Prototipo de entidad climática
cmd-weather-hint-time = Duración en segundos (déjalo vacío para duración infinita)
