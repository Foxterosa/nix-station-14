...
id-card-access-level-cryogenics = CrioSueño
id-card-access-level-emergency-shuttle-repeal = Revocar todo del transbordador de emergencia
...
id-card-access-level-engineering = Ingenieria
id-card-access-level-atmospherics = Atmosfericos
...
id-card-access-level-medical = Medico
id-card-access-level-chemistry = Quimica
...
id-card-access-level-chapel = Santuario
...
id-card-access-level-central-command = CentComm
