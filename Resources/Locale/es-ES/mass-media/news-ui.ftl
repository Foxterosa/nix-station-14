...
news-write-ui-footer-text = Sistema de redacción News#Manager™
news-write-ui-new-article = Artículo nuevo
...
news-publish-admin-announcement = {$actor} publicó el artículo de noticias {$title} de {$author}
