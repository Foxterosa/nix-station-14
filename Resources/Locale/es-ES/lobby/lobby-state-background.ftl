lobby-state-background-warden-title = Alcaide
lobby-state-background-warden-artist = Solbusaur

lobby-state-background-pharmacy-title = Farmacia
...
lobby-state-background-skellyvstherev-title = Skelly contra el Rev
lobby-state-background-skellyvstherev-artist = Hannah 'FairlySadPanda' Dawson

lobby-state-background-doomed-title = Condenados
lobby-state-background-doomed-artist = brainfood1183

lobby-state-background-blueprint-title = Plano
...
lobby-state-background-terminalstation-title = Estación Terminal
lobby-state-background-terminalstation-artist = aserovich

lobby-state-background-justaweekaway-title = A solo una semana
lobby-state-background-justaweekaway-artist = plantyfern

lobby-state-background-janishootout-title = Tiroteo del conserje
lobby-state-background-janishootout-artist = psychpsyo

lobby-state-background-reclaimernuke-title = Nuke en el reciclador
