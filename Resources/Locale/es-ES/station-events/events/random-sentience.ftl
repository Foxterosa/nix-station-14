...
random-sentience-event-data-1 = escaneos de nuestros sensores de largo alcance
random-sentience-event-data-2 = nuestros sofisticados modelos probabilísticos
...
random-sentience-event-strength-6 = de payaso
random-sentience-event-strength-7 = baja
random-sentience-event-strength-8 = de IA

## Announcement text

station-event-random-sentience-announcement = Según { $data }, creemos que algunos de los seres de la estación { $amount ->
    [1] { $kind1 }
    [2] { $kind1 } y { $kind2 }
    [3] { $kind1 }, { $kind2 } y { $kind3 }
    *[other] { $kind1 }, { $kind2 }, { $kind3 }, etc.
} han desarrollado una inteligencia de nivel { $strength } y la capacidad de comunicarse.

## Ghost role description

station-event-random-sentience-role-description = Eres un { $name } sapiente, traído a la vida por magia espacial.
