...
humanoid-profile-editor-open-image-button = Abrir imagenes
humanoid-profile-editor-save-button = Guardar
humanoid-profile-editor-reset-button = Restablecer
humanoid-profile-editor-spawn-priority-label = Prioridad de aparicion:
humanoid-profile-editor-eyes-label = Color de ojos:
humanoid-profile-editor-jobs-tab = Trabajos
humanoid-profile-editor-preference-unavailable-stay-in-lobby-button = Quedarse en el lobby si la preferencia no esta disponible.
humanoid-profile-editor-preference-unavailable-spawn-as-overflow-button = Ser {INDEFINITE($overflowJob)} {$overflowJob} si la preferencia no esta disponible.
humanoid-profile-editor-preference-jumpsuit = Mono
humanoid-profile-editor-preference-jumpskirt = Falda de uniforme
humanoid-profile-editor-preference-backpack = Mochila
humanoid-profile-editor-preference-satchel = Bolso
humanoid-profile-editor-preference-duffelbag = Bolso deportivo
humanoid-profile-editor-guidebook-button-tooltip = Haz clic para mas informacion
...
humanoid-profile-editor-preference-spawn-priority-cryosleep = CrioSueño
...
humanoid-profile-editor-naming-rules-warning = Advertencia: Los nombres y descripciones ofensivos o de IC LRP llevaran a la intervencion administrativa en este servidor. Lee nuestras \[Reglas\] para mas informacion.
humanoid-profile-editor-markings-tab = Marcas
humanoid-profile-editor-cybernetics-tab = Cibernetica
humanoid-profile-editor-flavortext-tab = Descripcion
...
trait-category-speech = Rasgos de habla
