...
shuttle-pilot-end = Dejaste de pilotar

shuttle-console-in-ftl = Actualmente en FTL
shuttle-console-mass = Demasiado grande para el FTL
...
shuttle-console-dock-toggle = Mostrar acoples

# MAP

shuttle-console-ftl-label = Estado del FTL
...
shuttle-console-docks-label = Acoples

shuttle-console-undock-fail = Falló el desacoplamiento
shuttle-console-dock-fail = Falló el acoplamiento
