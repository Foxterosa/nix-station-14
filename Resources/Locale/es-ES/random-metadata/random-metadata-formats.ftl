...
name-format-nukie-agent = Sanitario {$part0}
...
name-format-ert-pointman = Punta de lanza {$part0}
name-format-ert-officer = Oficial {$part0}
name-format-ert-rifle = Fusilero {$part0}
name-format-ert-grenade = Granadero {$part0}
name-format-ert-vanguard = Vanguardia {$part0}
name-format-ert-doctor = Doctor {$part0}
name-format-ert-corpsman = Sanitario {$part0}
