permissions-eui-do-not-have-required-flags-to-edit-admin-tooltip = No tienes los permisos necesarios para editar a este admin.
...
permissions-eui-menu-add-admin-button = Agregar admin
permissions-eui-menu-add-admin-rank-button = Agregar rango de admin
permissions-eui-menu-save-admin-rank-button = Guardar
permissions-eui-menu-remove-admin-rank-button = Quitar
permissions-eui-menu-admins-tab-title = Admins
permissions-eui-menu-admin-ranks-tab-title = Rangos de admin
permissions-eui-edit-admin-window-edit-admin-label = Editar al admin {$admin}
permissions-eui-edit-admin-window-name-edit-placeholder = Usuario/ID de usuario
permissions-eui-edit-admin-window-title-edit-placeholder = Título personalizado; déjalo vacío para heredar el título del rango.
...
permissions-eui-edit-admin-window-remove-flag-button = Quitar

cmd-permissions-desc = Abre el panel de permisos de admin.
