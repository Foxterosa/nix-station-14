...
play-global-sound-command-player-not-found = No se encontró al jugador "{$username}".
play-global-sound-command-volume-parse = Se especificó un volumen inválido: {$volume}.
